...
public class BoundaryAfficherVillage {
	...
	public void afficherVillage() {
		...
		System.out.println("Ce village possede un joli marche avec " + controlAfficherVillage.donnerNbEtals() + " etals mis a la disposition des villageois afin qu'ils puissent vendre leurs produits.");
